...
The main stack I use every day: node, go, erlang, bash, docker, ansible
...
``` bash
brew install vim --override-system-vim  # OS X
```
...
* `<ctrl-E>` -> opening/close NERD-TREE
* `t` -> on NERDTREE file - opening file in new tab
...
* [hybrid](https://github.com/w0ng/vim-hybrid) - Mine favourite theme
